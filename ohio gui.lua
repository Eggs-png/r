...
Notify("Welcome to Ohio Gui!", "Have a great time trolling players.", 3)
-- Main frame
...
mainFrame.BackgroundColor3= Color3.fromRGB(0, 200, 0)
...
tooltip.BackgroundColor3   = Color3.fromRGB(0,30,0)
...
leftCat.BackgroundColor3  = Color3.fromRGB(0,100,0)
...
FunctionManager:register("V̴̢̢̡̨̧̧̻̥̼͕̲̰͈̙͍͉̗̹͇͚͔̜̘̘͓͚͓̺̙̱̗͈͉̬̦̜͔̲͕̑̈́̔͆̓͗́̍͐̔̃͒̃̎̈́͐̇͜͜Ǫ̶͖̩̭̟͇͓̬̣̺̝̰̙̯͖͉̝̬̼̗̭̘̦̞̘͈̥̙̼̮͚̠͎̩͖̯̪̞̻͕͉̮̗͈̅͛̈́̎͑̈́̂̑́̓̅̆͌̆̂̇́̓̀̑̂͛̀̊̈́̎̈́̏̀̈̃̄́͆̚͠͠ͅͅḮ̸̡̨̢̡̧̢̛̛̭̟͚̺̯̼̙͙̗̫̥̣͓̦̮͓͚̰͕̊̎̓̂͛̉͛͐͊̎̀̇͂̒͗̑̀̊̈̍͗̀͑͂́̌̅́̅̀̍̕̚̕͠D̵̢̡̨̥̳͇͔̮̭̗̖̜̤͖̠̲̺͚̗͔̩̞̖͇̯̥̖͎̩͓͎͎̩̫̿̉͛͊̈͆̓͐̉̊͆̾͜", function()
	...
	local function setupCharacter(character)
		...
		tecks.Text = "V̴̢̢̡̨̧̧̻̥̼͕̲̰͈̙͍͉̗̹͇͚͔̜̘̘͓͚͓̺̙̱̗͈͉̬̦̜͔̲͕̑̈́̔͆̓͗́̍͐̔̃͒̃̎̈́͐̇͜͜Ǫ̶͖̩̭̟͇͓̬̣̺̝̰̙̯͖͉̝̬̼̗̭̘̦̞̘͈̥̙̼̮͚̠͎̩͖̯̪̞̻͕͉̮̗͈̅͛̈́̎͑̈́̂̑́̓̅̆͌̆̂̇́̓̀̑̂͛̀̊̈́̎̈́̏̀̈̃̄́͆̚͠͠ͅͅḮ̸̡̨̢̡̧̢̛̛̭̟͚̺̯̼̙͙̗̫̥̣͓̦̮͓͚̰͕̊̎̓̂͛̉͛͐͊̎̀̇͂̒͗̑̀̊̈̍͗̀͑͂́̌̅́̅̀̍̕̚̕͠D̵̢̡̨̥̳͇͔̮̭̗̖̜̤͖̠̲̺͚̗͔̩̞̖͇̯̥̖͎̩͓͎͎̩̫̿̉͛͊̈͆̓͐̉̊͆̾͜"
		...
		coroutine.wrap(function()
			while character:IsDescendantOf(workspace) do
				changeName("SUFFER WITH AGONY IN PURGATORY")
				shakeTag()
				task.wait(0.2)
				changeName("STOP")
				task.wait(0.1)
				...
				shakeTag()
				task.wait(0.2)
				changeName("V̴̢̢̡̨̧̧̻̥̼͕̲̰͈̙͍͉̗̹͇͚͔̜̘̘͓͚͓̺̙̱̗͈͉̬̦̜͔̲͕̑̈́̔͆̓͗́̍͐̔̃͒̃̎̈́͐̇͜͜Ǫ̶͖̩̭̟͇͓̬̣̺̝̰̙̯͖͉̝̬̼̗̭̘̦̞̘͈̥̙̼̮͚̠͎̩͖̯̪̞̻͕͉̮̗͈̅͛̈́̎͑̈́̂̑́̓̅̆͌̆̂̇́̓̀̑̂͛̀̊̈́̎̈́̏̀̈̃̄́͆̚͠͠ͅͅḮ̸̡̨̢̡̧̢̛̛̭̟͚̺̯̼̙͙̗̫̥̣͓̦̮͓͚̰͕̊̎̓̂͛̉͛͐͊̎̀̇͂̒͗̑̀̊̈̍͗̀͑͂́̌̅́̅̀̍̕̚̕͠D̵̢̡̨̥̳͇͔̮̭̗̖̜̤͖̠̲̺͚̗͔̩̞̖͇̯̥̖͎̩͓͎͎̩̫̿̉͛͊̈͆̓͐̉̊͆̾͜")
				shakeTag()
				task.wait(0.3)
				changeName("HOPELESS")
				shakeTag()
...
FunctionManager:register("Sound GUI", function()
	...
	Frame.BorderColor3 = Color3.fromRGB(0, 255, 4)
	...
	AddSoundId.BorderColor3 = Color3.fromRGB(0, 255, 0)
	...
	SoundIds.BorderColor3 = Color3.fromRGB(0, 255, 0)
	...
	Default.BorderColor3 = Color3.fromRGB(0, 255, 0)
	...
	Credits.Text = "made by: jpxfrd. On discord!"
	...
	PlayBackSpeed.BorderColor3 = Color3.fromRGB(0, 255, 0)
	...
	Volume.BorderColor3 = Color3.fromRGB(0, 255, 0)
	...
	Looped.BorderColor3 = Color3.fromRGB(0, 255, 0)
	...
	Open.BorderColor3 = Color3.fromRGB(0, 255, 0)
